  ...
  return (
    <AccordionPrimitive.Header className='flex w-full'>
      ...
      >
        ...
        {/* Chevron with background change */}
        <span
          className={cn(
            'flex items-center justify-center size-6 md:size-10 rounded-full bg-foreground transition-colors duration-500',
            'group-data-[state=open]:bg-primary'
          )}
        >
          <ChevronDownIcon
            className={cn(
              'text-white pointer-events-none size-3 md:size-5 shrink-0 transition-transform duration-500',
